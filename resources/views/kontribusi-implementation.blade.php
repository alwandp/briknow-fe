            ...
            {{-- STEP 2 --}}
                <div class="mb-5 setup-content" style="display:none;" id="step-2">
                    ...
                    <div id="piloting_view" style="display:none">
                        <div class="mb-4">
                            <h4>Deskripsi Piloting<span class="text-danger ml-1">*</span></h4>
                            <div class="form-group row ">
                    ...
                    <div id="rollout_view" style="display:none">
                        <div class="mb-4">
                            <h4>Deskripsi Roll-Out<span class="text-danger ml-1">*</span></h4>
                            <div class="form-group row ">
                                <div class="col-md-12">
                    ...
                    <div id="sosialisasi_view" style="display:none">
                        <div class="mb-4">
                            <h4>Deskripsi Sosialisasi<span class="text-danger ml-1">*</span></h4>
                            <div class="form-group row ">
                                <div class="col-md-12">
