...
@section('breadcumb', 'Lesson Learned')
@section('back', route('home'))

@section('content')
    <div class="row mx-4">
        <div class="col-md-12" id="konten">
            <h3 class="pl-2 mt-3">Lesson Learned</h3>
            <div class="d-flex justify-content-start mb-3">
                <div class="p-2 bd-highlight">
                    ...
                    @if(request()->segment(count(request()->segments())) === 'lessonlearned')
                        <ul class="dropdown-menu dropdown-menu-left">
                            <li onclick="sortByTahap('sortInitLesson')" id="sortInitLesson" data-value="all"
                            ...
                            <li onclick="sortByTahap('pilotSort')" id="pilotSort" data-value="Pilot Run" class="dropdown-item">
                                Pilot Run
                            </li>
                    ...
                    @else
                        <ul class="dropdown-menu dropdown-menu-left">
                            <li id="sortInitLesson" data-value="all"
                        ...
                        <div class="col-4">
                            <div class="bd-highlight">
                                <div class="d-flex justify-content-end w-100">
                                    <select name="direktorat" id="direktorat-lesson-init" onchange="changeDirec()"  class="form-control text-black lesson-select select2" data-live-search="true"
                            ...
                            <div class="bd-highlight" id="search">
                                <div class="input-group w-100">
                                    <input type="text" style="border-radius: 8px 0 0 8px;" class="form-control"
                                        id="searchLessoninit" placeholder="Search Project">
