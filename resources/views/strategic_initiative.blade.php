...
<div id="app" style="min-height: 100vh; background-color: white">
...
{{--                        <a href="{{ route('lessonlearned') }}" class="dropdown-item">Lesson Learned</a> --}}
                    ...
                    <div class="row mx-0">
                        <div class="col-md-12" id="konten">
                            ...
                            <div class="d-flex justify-content-end mt-3">
                                <div class="p-2">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-left">
                                            <li onclick="sortingBy('sortInitStra')" id="sortInitStra" data-value="" class="dropdown-item">Sort By</li>
                                            <li onclick="sortingBy('titleSort')" id="titleSort" data-value="nama" class="dropdown-item">Judul</li>
                                ...
                                <div class="p-2">
                                    <div class="dropdown">
                                        <button id="btn-filter-tahap" data-toggle="dropdown" class="btn btn-outline-secondary bg-white dropdown-toggle">
                                            Implementation
                                        </button>
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li onclick="filterTahap('all')" id="all" data-value="all" class="dropdown-item">All Implementation</li>
                                            <li onclick="filterTahap('piloting')" id="piloting" data-value="piloting" class="dropdown-item">Piloting</li>
                                            <li onclick="filterTahap('roll-out')" id="roll-out" data-value="roll-out" class="dropdown-item">Roll Out</li>
                                            <li onclick="filterTahap('sosialisasi')" id="sosialisasi" data-value="sosialisasi" class="dropdown-item">Sosialisasi</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="p-2">
                            ...
                            <div>
                                ...
                                @else --}}
                                <div id="card-content-strategic" class="row w-100"></div>
                                {{-- @endif --}}
                            </div>
