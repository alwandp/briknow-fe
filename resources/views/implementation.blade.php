                ...
                <ul class="sidebar-menu text-center">
                    ...
                    <li class="nav-item dropdown pb-2">
                        <a href="{{route('mycomsupport.implementation')}}"
                           ...
                           tabindex="-1" role="button" onclick="resetStorage()">
                    ...
                    <div class="text-dark p-2">
                        ...
                        <ul class="collapse" id="collapsedirectorat">
                            <div class="row d-flex spacing-filter">
                                <select name="direktorat" id="direktorat-impl-init" class="form-control text-black select2" data-live-search="true"
                                ...
                                <div class="mr-auto p-2">
                                    @forelse($type_list as $item)
                                        ...
                                        <a href="{{route('mycomsupport.implementation.type', ['type'=>$item['id']])}}"  id="{{$item['id']}}" role="button"
                                           class="btn-com mt-2 mr-3 {{request()->path() == $item['path']  ? ' active disabled' : ''}}" onclick="resetStorage()">{{$item['name']}}</a>
                                    @empty
                                    @endforelse
                                </div>
