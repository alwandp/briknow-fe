    ...
    <div class="main-wrapper">
        ...
        <div class="main-content">
            <section class="section">
			    ...
			    <input type="hidden" id="namaProject" name="namaProject" value="{{ $data->nama }}" >
                            @if (count($piloting) > 0)
				<div class="d-flex">
				   <div class="row w-100">
  				       <div class="col-12">
					  <h4>Piloting</h4>
				       ...
				       <div class="col-12">
					  <p>{{ count($piloting).' Files' }}</p>
                                       </div>

                                       <div class="d-flex w-100">
					  <div class="d-flex w-100">
					     @foreach ($piloting as $p)
                                               <div class="col-2 justify-content-center">
						 <div class="card h-100" style="border-radius: 16px">
						   <img class="img-fluid img-content" src="{{ asset_app('/storage/'.$p->thumbnail) }}" alt="Card image cap" />
						 </div>
					       </div>
                                             @endforeach
                                          </div>
					 ...
					 <div class="col-2 justify-content-center">
                                                <a href="{{ route('mycomsupport.implementation') }}" onclick="toPiloting()">
                                                    <div class="card align-items-center h-100 d-flex justify-content-center"
                                                         style="border-radius: 16px">
                                                        <div class="img-fluid">
                                                            <img src="{{asset_app('assets/img/logo/view_all_ic.png')}}"/>
				...
				<div class="d-flex">
				   <div class="row w-100">
					  ...
					  <h4>Roll-Out</h4>
				       ...
				       <div class="col-12">
					  <p>{{ count($rollOut).' Files' }}</p>
                                       </div>

                                       <div class="d-flex w-100">
					  <div class="d-flex w-100">
					     @foreach ($rollOut as $r)
                                               <div class="col-2 justify-content-center">
						 <div class="card h-100" style="border-radius: 16px">
						   <img class="img-fluid img-content" src="{{ asset_app('/storage/'.$r->thumbnail) }}" alt="Card image cap" />
						 </div>
					       </div>
                                             @endforeach
                                          </div>
					 ...
					 <div class="col-2 justify-content-center">
                                                <a href="{{ route('mycomsupport.implementation') }}/roll-out" onclick="toPiloting()">
                                                    <div class="card align-items-center h-100 d-flex justify-content-center"
                                                         style="border-radius: 16px">
                                                        <div class="img-fluid">
                                                            <img src="{{asset_app('assets/img/logo/view_all_ic.png')}}"/>
				   ...
				   <div class="row w-100">
					  ...
					  <div class="d-flex w-100">
					     @foreach ($sosialisasi as $s)
                                               <div class="col-2 justify-content-center">
						 <div class="card h-100" style="border-radius: 16px">
						   <img class="img-fluid img-content" src="{{ asset_app('/storage/'.$s->thumbnail) }}" alt="Card image cap" />
						 </div>
					       </div>
                                             @endforeach
                                          </div>
					 ...
					 <div class="col-2 justify-content-center">
                                                <a href="{{ route('mycomsupport.implementation') }}/sosialisasi" onclick="toPiloting()">
                                                    <div class="card align-items-center h-100 d-flex justify-content-center"
                                                         style="border-radius: 16px">
                                                        <div class="img-fluid">
                                                            <img src="{{asset_app('assets/img/logo/view_all_ic.png')}}"/>
